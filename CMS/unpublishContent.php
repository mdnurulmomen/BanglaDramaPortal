	...
	<?php include("dashBoard.php"); ?>
				...
				<div class="agile-two-grids">
					<div class="agile-bottom-grid">
						<div class="area-grids-heading">
							<h3>All UnPublished Parts <i class="fa fa-hand-o-down"></i></h3>
						</div>
						...
						<div class="text-center">
							...
							<?php		
								...
								WHERE (DRAMACONTENT.STATUS = 0) ORDER BY DRAMACONTENT.UPLOAD_DATE DESC";
		...
		<script>		
			$("button").click(function(e){
				...
				alert(idClicked);
				$.post("action_page.php",{partsForThisCategory : idClicked, status:0},	
